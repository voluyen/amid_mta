...
def remove_inf_nan_logits(input_ids: torch.Tensor, logits: torch.Tensor) -> torch.Tensor:
    """
    ...
    logits[torch.isinf(logits)] = dtype_info.min  # 替换 inf 和 -inf
    logits[torch.isnan(logits)] = dtype_info.min  # 替换 nan
